...
using namespace std;
vector<int> primes;
int approx_prime_count(const int N)
{
...
void sieve(const int N = 1000000000, const int Q = 17, const int L = 32768)
{
